...
add_action( 'wp', 'automotive_insert_into_auto_cpt' );

function automotive_check_for_similar_meta_ids() {
...
function automotive_query_garage_table( $car_available_in_cpt_array ) {
    global $wpdb;
...
function automotive_insert_into_auto_cpt() {

    $car_available_in_cpt_array = automotive_check_for_similar_meta_ids();
    $database_results = automotive_query_garage_table( $car_available_in_cpt_array );
